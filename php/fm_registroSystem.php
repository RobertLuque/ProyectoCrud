...
//Codigo sql
$sql = "INSERT INTO registros (idPerson, nombres, apellidos, cargo, celular, correo, nombreMunicipio, direccion,
distrito, provincia, region, telefono, correoMunicipal, paginaWeb, estado) VALUES ( NULL,'$nombre', '$apellido',
'$cargo', $celular, '$correo', '$nombreMunicipio', '$direccion', '$distrito', '$provincia', '$region', $telefono,
'$correoMunicipal', '$paginaWeb', '$estado')";
...
header("Location: ../msg_registroEnviado.php");
}
